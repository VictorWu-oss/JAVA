...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Country top = Country.countryWithHighestCH4InYear(countries, 2000);
        System.out.println(top.getName() + " " + "had the highest methane gas emissions in 2000\n");
        ...
        Country highest = Country.countryWithHighestChangeInEmissions(countries, 1988, 2012);
        System.out.println(highest.getName() + " " + "had the highest increase in GHG emissions between 1988 and 2012\n");

        // Which sector had the highest average in greenhouse gas emissions between 1988 and 2012?
        Sector highAverage = Sector.sectorWithBiggestChangeInEmissions(sectors, 1988,2012);
        System.out.println(highAverage.getName() + " " + "had the highest average in greenhouse gas emissions between 1988 and 2012");
    }
