...
public class PartTwoTestCases {
    ...
    // Test for the instance methods of Country and Sector
    @Test
    public void testYearWithHighestEmissionsSector(){
        // creates the testable Sector object
    ...
    public void testYearWithHighestEmissionsCountry() {
        // creates the testable Country object
        Map<Integer, Emission> emissions = new HashMap();
        emissions.put(1970, new Emission(288000.0, 6840000.0, 46900000.0));
        emissions.put(1971, new Emission(290000.0, 6890000.0, 45600000.0));
