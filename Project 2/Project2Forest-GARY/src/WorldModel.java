    ...
    */
    ...
    private void parseSapling(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 1) {
            Sapling entity = new Sapling(id, pt, imageStore.getImageList("sapling"));
    ...
    private void parseDude(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 3) {
            DudeNotFull entity = new DudeNotFull(id, pt, Double.parseDouble(properties[0]), Double.parseDouble(properties[1]), Integer.parseInt(properties[2]), imageStore.getImageList("dude"));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseFairy(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 2) {
            Fairy entity = new Fairy(id, pt, Double.parseDouble(properties[1]), Double.parseDouble(properties[0]), imageStore.getImageList("fairy"));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseTree(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 3) {
            Tree entity = new Tree(id, pt, Double.parseDouble(properties[1]), Double.parseDouble(properties[0]), Integer.parseInt(properties[2]), imageStore.getImageList("tree"));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseObstacle(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 1) {
            Obstacle entity = new Obstacle(id, pt, Double.parseDouble(properties[0]), imageStore.getImageList("obstacle"));
            this.tryAddEntity(entity);
        }else{
    ...
    private void parseHouse(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 0) {
            House entity = new House(id, pt, imageStore.getImageList("house"));
            this.tryAddEntity(entity);
        }else{
            throw new IllegalArgumentException(String.format("%s requires %d properties when parsing", "key", 0));
        }
    }

    private void parseStump(String[] properties, Point pt, String id, ImageStore imageStore) {
        if (properties.length == 0) {
            Stump entity = new Stump(id, pt, imageStore.getImageList("stump"));
            this.tryAddEntity(entity);
        }else{
