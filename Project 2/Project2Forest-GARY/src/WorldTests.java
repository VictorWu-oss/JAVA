...
public class WorldTests {
    ...
    ///  Fairy's route to a stump, works when ran by itself but no collectively
    ...
    public void testAStarPathingDude(){
        ...
        ///  Within lifetime dude will collect some resources, and the stump will grow to a sapling
    ...
    public void testAStarPathingFairy(){
        ...
        Assertions.assertEquals("myfairy 1 2 0", entities.get(0));
        /// Sapling HP varies with run time
        Assertions.assertTrue(entities.get(1).startsWith("tree_sapling_ 10 14"));
        Assertions.assertEquals("sapling_ 0 14 3", entities.get(2));
    }
